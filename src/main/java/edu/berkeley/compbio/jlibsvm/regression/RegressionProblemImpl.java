 ...
 * @version $Id$
 */
public class RegressionProblemImpl<P, R extends RegressionProblem<P, R>> extends
    ExplicitSvmProblemImpl<Float, P, R>
...
// --------------------------- CONSTRUCTORS ---------------------------
  ...
  public RegressionProblemImpl(RegressionProblemImpl<P, R> backingProblem, Set<P> heldOutPoints) {
    super(new SubtractionMap<P, Float>(backingProblem.examples, heldOutPoints),
...
// -------------------------- OTHER METHODS --------------------------
  ...
  public R createScaledCopy(Map<P, Float> scaledExamples, Map<P, Integer> scaledExampleIds,
    ...
    return (R) new RegressionProblemImpl<P, R>(scaledExamples, scaledExampleIds,
        learnedScalingModel);
  }
}
